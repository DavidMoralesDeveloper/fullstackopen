...
const WarningNotUse = () => <h2> No feed backgiven</h2>
...
const ChangeState = ({ all, average, positive, good, neutral, bad }) => (all === 0 
  ? <WarningNotUse /> 
...
const App = () => {
  ...
  return (
    ...
    <ChangeState all={all} average={average}  positive={positive} good={good} neutral={neutral} bad={bad} />
